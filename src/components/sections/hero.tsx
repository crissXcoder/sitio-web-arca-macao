    ...
    <section className="relative h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <HeroParallax>
        <Image
          ...
          fill
          priority
          className="object-cover object-right lg:object-center grayscale-[0.1] brightness-[0.7] scale-105"
        />
          ...
          <div className="max-w-5xl space-y-12 text-left">
            <div className="space-y-8">
              ...
              <div className="overflow-hidden">
                <h1 className="font-serif text-8xl leading-[0.85] font-light tracking-tighter text-white sm:text-9xl lg:text-[12rem]">
            ...
            <div className="max-w-2xl space-y-8">
              <p className="font-sans text-xl leading-relaxed text-white/60 sm:text-2xl font-light tracking-wide">
                {dict.hero.subtitle}
              </p>
              ...
              <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center">
                <Button 
                  size="lg" 
                  className="group relative h-16 overflow-hidden rounded-full px-10 bg-white text-black hover:bg-accent transition-all duration-500 font-black uppercase text-[11px] tracking-widest"
                >
                ...
                <button className="group flex items-center gap-4 text-white/80 hover:text-white transition-colors duration-500">
                  <div className="flex items-center justify-center w-14 h-14 rounded-full border border-white/20 group-hover:border-accent transition-all duration-500">
      ...
      <div className="absolute right-12 bottom-24 hidden lg:flex flex-col gap-8 z-20">
        <div className="p-6 bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl max-w-[200px] hover:bg-white/[0.05] transition-colors duration-500">
          <span className="block font-sans text-[10px] font-black text-accent uppercase tracking-widest mb-2">Población</span>
          <span className="block font-serif text-3xl text-white">1,500+</span>
          <p className="text-[11px] text-white/40 mt-1">Individuos en estado salvaje</p>
        </div>
        <div className="p-6 bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl max-w-[200px] hover:bg-white/[0.05] transition-colors duration-500">
          <span className="block font-sans text-[10px] font-black text-accent uppercase tracking-widest mb-2">Hábitat</span>
          <span className="block font-serif text-3xl text-white">Seco</span>
          <p className="text-[11px] text-white/40 mt-1">Bosque tropical de Guanacaste</p>
        </div>
      </div>

      {/* Scroll Indicator - Premium */}
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 z-20 opacity-40">
        <span className="font-sans text-[9px] font-black tracking-[0.5em] text-white uppercase">Explorar</span>
        <div className="relative h-12 w-px overflow-hidden bg-white/20" aria-hidden="true">
